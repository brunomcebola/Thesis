...
setup_file="setup_master.py"

ssh_addr="argos-master"

master_folder="home/thales/Argos"
...
echo "$ ssh $ssh_addr \"$master_folder/pip install --force-reinstall $master_folder/$whl_file\""
ssh $ssh_addr "$master_folder/pip install --force-reinstall $master_folder/$whl_file"
