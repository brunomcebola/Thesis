...
from transformers import VivitForVideoClassification, VivitModel  # type: disable=wrong-import-position
...
# Load model
print("Loading model...")
model = VivitForVideoClassification.from_pretrained("models/kinetics400").to(device)
