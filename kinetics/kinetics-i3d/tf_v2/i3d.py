...
class Branch(snt.Module):
    ...
    def __init__(
        ...
        super(Branch, self).__init__(name=name)
...
class MixedLayer(snt.Module):
    ...
    def __init__(
        ...
        self.branch_0 = Branch(
            name="Branch_0",
            is_training=is_training,
            a_output_channels=branch_0_output_channels,
            a_kernel_shape=[1, 1, 1],
            a_name=branch_0_name,
...
class InceptionI3d(snt.Module):
    ...
    def __init__(
        ...
        self.Mixed_3b = MixedLayer(  # pylint: disable=invalid-name
            name="Mixed_3b",
            is_training=is_training,
            branch_0_output_channels=64,
            branch_0_name="Conv3d_0a_1x1",
        ...
        self.Mixed_5b = MixedLayer(  # pylint: disable=invalid-name
            ...
            branch_2_a_name="Conv3d_0a_1x1",
            branch_2_b_output_channels=128,
            branch_2_b_name="Conv3d_0a_3x3",  # NOTE: this is wrong from the original implementation
            branch_3_b_output_channels=128,
            branch_3_b_name="Conv3d_0b_1x1",
        )
